...
<body>
	<div class="container">
		<div align="center">
			<img src="img/pesawat.jfif" class="rounded-bottom">
			<br><br>
	...
	<form action="index.php" method="post">
		<table width="500px">
			...
			<tr>
				...
				<td>:</td>
				<td width="80%"><input class="form-control" type="text" name="maskapai" class="inputtext" placeholder="Nama Maskapai" required=""></td> <!-- Input nama Maskapai -->
			</tr>
			</div>
			<div class="form-group">
			<tr>
				...
				<td>:</td>
				<td>
					<select name="ruteasal" class="form-control"> 																						<!-- Input Bandara Asal -->
			...
			<tr>
				...
				<td>:</td>
				<td>
					<select name="rutetujuan" class="form-control">
			...
			<tr>
				...
				<td>:</td>
				<td><input type="number" class="form-control" name="harga" class="inputtext" placeholder="Harga Tiket" required=""></td> 				<!-- Input Harga Tiket -->
			</tr>
			</div>
			<tr>
				<td colspan="3" style="text-align: center;"><input class="form-control btn btn-secondary" type="submit" value="Submit" name="submit"></td>					<!-- Submit Form -->
			</tr>
		</table>		
	</form> <br>
	</div>
